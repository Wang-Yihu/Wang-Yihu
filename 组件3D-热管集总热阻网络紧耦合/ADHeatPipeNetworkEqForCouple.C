...
#include "ADHeatPipeNetworkEqForCouple.h"
#include "Function.h"

// e - evaporation section; i - heat insulation section; c - condensation section
// p - heat pipe clad; w - wick; v - vapor region
// r - radial; a - axial
registerMooseObject("asnerdihp_extest2App", ADHeatPipeNetworkEqForCouple);

InputParameters
ADHeatPipeNetworkEqForCouple::validParams()
{
...
ADHeatPipeNetworkEqForCouple::ADHeatPipeNetworkEqForCouple(const InputParameters & parameters)
...
ADReal 
ADHeatPipeNetworkEqForCouple::_k_w(ADReal T)
{
...
ADReal
ADHeatPipeNetworkEqForCouple::computeQpResidual()
{ 
  ...
  switch (_equation) 
  {
    case 1:
    {
      ...
      return -(_Q_in[_i] + _T_w_e[_i]/R_p_to_w_e_r - _T_p_e[_i]/R_p_to_w_e_r + _T_p_i[_i]/R_p_e_to_i_a - _T_p_e[_i]/R_p_e_to_i_a);
    }
