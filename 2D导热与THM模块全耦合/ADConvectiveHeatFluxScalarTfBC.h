 ...
 */
class ADConvectiveHeatFluxScalarTfBC : public ADIntegratedBC
{
public:
  static InputParameters validParams();

  ADConvectiveHeatFluxScalarTfBC(const InputParameters & parameters);

protected:
  virtual ADReal computeQpResidual() override;

  /// Far-field temperature variable
  const ADVariableValue & _T_infinity;
